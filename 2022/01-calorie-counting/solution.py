...
def _get_new_maxes(amounts, new_amount):
    min_amount = min(amounts)
    if new_amount > min_amount:
        min_amount_index = amounts.index(min_amount)
        amounts[min_amount_index] = new_amount
    ...
    with open("input.txt") as file:
        for line in file:
            ...
            if cleaned_line:
                ...
                _get_new_maxes(max_elves_amounts, current_elf_amount)
                current_elf_amount = 0
                print(max_elves_amounts, sum(max_elves_amounts))
